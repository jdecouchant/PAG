...
public class SessionMember 
{
    ...
    public SessionMember (short selfId, int listeningPort, int RTE, int FANOUT_CLI, int FANOUT_SVR, int PERIOD, int EPOCH, ArrayList<Node> nodesList, 
        ...
        if (selfId != 0) // The node is a peer
            ...
            this.server = new Source(listeningPort, nodesList, FANOUT_SVR, UPDATES_PER_ROUND, UPDATE_LEN, EPOCH);   
    }
