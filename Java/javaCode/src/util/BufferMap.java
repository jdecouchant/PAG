...
public class BufferMap {        
    ...
    // Return the updates received during previous rounds
    public Set<Integer> getLastRoundUpdates(int roundId, int duration) { // We do not propose updates to a node we know
        Set<Integer> updatesNewlyReceived = new HashSet<Integer>();
        ...
        while (updatesIdItr.hasNext()) {
            ...
            if (updateInfo.receptionRound >= roundId - duration)// && updateInfo.senderId != toNodeId)
